...
- 2 [User interface and Projects](ui-projects.md)
- 3 [Components and Devices](components-devices.md)
- 4 [I/O Devices](iodevices.md)
    - 4.1 [File](file.md)
    - 4.2 [NewAE (ChipWhisperer)](newae.md)
    - 4.3 [Random number generator](rng.md)
    - 4.4 [Serial port](serialport.md)
    - 4.5 [Smart card](smartcard.md)
