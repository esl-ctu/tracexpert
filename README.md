...
```
cd existing_repo
git remote add origin https://gitlab.fit.cvut.cz/sochapet/TraceXpert.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.fit.cvut.cz/sochapet/TraceXpert/-/settings/integrations)
