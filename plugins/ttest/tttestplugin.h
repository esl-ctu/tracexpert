#ifndef TTTESTPLUGIN_H
#define TTTESTPLUGIN_H

#include "TTTestPlugin_global.h"
#include "tplugin.h"


class TTTESTPLUGIN_EXPORT TTTestPlugin : public QObject, TPlugin
{

    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.cvut.fit.TraceXpert.PluginInterface/1.0" FILE "tttestplugin.json")
    Q_INTERFACES(TPlugin)

public:
    TTTestPlugin();
    virtual ~TTTestPlugin() override;
