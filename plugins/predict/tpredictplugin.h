#ifndef TPREDICTPLUGIN_H
#define TPREDICTPLUGIN_H

#include "TPredictPlugin_global.h"
#include "tplugin.h"


class TPREDICTPLUGIN_EXPORT TPredictPlugin : public QObject, TPlugin
{

    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.cvut.fit.TraceXpert.PluginInterface/1.0" FILE "tpredictplugin.json")
    Q_INTERFACES(TPlugin)

public:
    TPredictPlugin();
    virtual ~TPredictPlugin() override;
