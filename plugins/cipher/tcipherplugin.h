...
#ifndef TCIPHERPLUGIN_H
#define TCIPHERPLUGIN_H

#include "TCipherPlugin_global.h"
#include "tplugin.h"


class TCIPHERPLUGIN_EXPORT TCipherPlugin : public QObject, TPlugin
{

    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.cvut.fit.TraceXpert.PluginInterface/1.0" FILE "tcipherplugin.json")
    Q_INTERFACES(TPlugin)

public:
    TCipherPlugin();
    virtual ~TCipherPlugin() override;
