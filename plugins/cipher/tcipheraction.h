...
#ifndef TCIPHERACTION_H
#define TCIPHERACTION_H

#include "tanaldevice.h"

class TCipherAction : public TAnalAction
{
public:
    explicit TCipherAction(QString name, QString info, std::function<void(void)> run);
