...
#include "TNewPlugin_global.h"
#include "tplugin.h"


class TNEWPLUGIN_EXPORT TNewPlugin : public QObject, TPlugin
{

    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.cvut.fit.TraceXpert.PluginInterface/1.0" FILE "tnewplugin.json")
    Q_INTERFACES(TPlugin)

public:
    TNewPlugin();
    virtual ~TNewPlugin() override;
